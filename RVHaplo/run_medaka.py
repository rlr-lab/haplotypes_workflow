...
if flag == '1':
    os.system(f"rm -rf {file_path}/medaka/medaka_0")
    os.system(f"mkdir {file_path}/medaka/medaka_0")
    ...
    os.system(f'mini_align -i {file_path}/medaka/fastx/cluster.fastq -r {file_path}/medaka/fastx/consensus.fasta -m -t 4 -d lr:hq -p {file_path}/medaka/reads')
    ...
    os.system(f'medaka sequence {file_path}/medaka/contig.hdf {file_path}/medaka/fastx/consensus.fasta {file_path}/medaka/medaka_0/consensus.fasta --threads 4')
    os.system(f'cp {file_path}/medaka/medaka_0/consensus.fasta {file_path}/{file_prefix}_haplotypes.fasta')
else:
    ...
    for i in range(num):
        ...
        os.system(f'mini_align -i {file_path}/medaka/fastx/cluster_{i}.fastq -r {file_path}/medaka/fastx/consensus_{i}.fasta -m -t 4 -d lr:hq -p {file_path}/medaka/medaka_{i}/reads')
